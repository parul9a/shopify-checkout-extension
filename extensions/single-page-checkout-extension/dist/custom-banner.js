...
${errorInfo.componentStack}`);
  ...
  function App() {
    ...
    const [selectValue, setSelectValue] = (0, import_react18.useState)("");
    const [inputValue, setInputValue] = (0, import_react18.useState)("");
    const [err, setErr] = (0, import_react18.useState)();
    const [validationError, setValidationError] = (0, import_react18.useState)("");
    const [selectError, setSelectError] = (0, import_react18.useState)("");
    const [showErrorBanner, setShowErrorBanner] = (0, import_react18.useState)(false);
