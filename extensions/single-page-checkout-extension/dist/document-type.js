(() => {
  ...
  // extensions/single-page-checkout-extension/src/Checkout.jsx
...
${errorInfo.componentStack}`);
  ...
  function App() {
    ...
    const [selectValue, setSelectValue] = (0, import_react19.useState)("");
    const [inputValue, setInputValue] = (0, import_react19.useState)("");
    const [err, setErr] = (0, import_react19.useState)();
    const [validationError, setValidationError] = (0, import_react19.useState)("");
    const [selectError, setSelectError] = (0, import_react19.useState)("");
    const [showErrorBanner, setShowErrorBanner] = (0, import_react19.useState)(false);
    const [loading, setLoading] = (0, import_react19.useState)(false);
    const canBlockProgress = useExtensionCapability("block_progress");
    const [doctype, setDoctype] = useStorageState("doc-type");
    const [docnum, setDocnum] = useStorageState("doc-num");
    const label = canBlockProgress ? Name_text_field : Name_text_field + "(optional)";
    (0, import_react19.useEffect)(() => {
      console.log("selectValue", selectValue, "inputValue", inputValue);
      if (canBlockProgress && isNumberSet() && isSelectSet() && !isNumberValid()) {
        showValidationErrors("Enter Valid Details");
        return;
      }
      clearValidationErrors();
      if (doctype.data !== void 0 && doctype.data !== null && docnum.data !== void 0 && docnum.data !== null) {
      ...
      items.map((item) => {
        if (item.name == selectValue) {
          ...
          if (pattern.test(inputValue)) {
            ...
            if (item.err != null && item.err != void 0) {
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(BlockStack2, { children: enableDropdown === "Show" ? /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_jsx_runtime4.Fragment, { children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Form2, { children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(Grid2, { columns: ["50%", "50%"], spacing: "base", children: [
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(GridItem2, { children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(
        Select2,
        {
          id: "selectValue",
    ...
    ] }) }) }) : /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(BlockStack2, { children: " " }) });
  }
  function useStorageState(key) {
    ...
    const setStorage = (0, import_react19.useCallback)(
      (value) => {
  ...
  // extensions/single-page-checkout-extension/src/DocumentType.jsx
  var import_react20 = __toESM(require_react());
  var import_jsx_runtime5 = __toESM(require_jsx_runtime());
  var DocumentType_default = reactExtension("purchase.checkout.contact.render-after", () => /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(App2, {}));
  function App2() {
    const [checked, setChecked] = (0, import_react20.useState)(false);
    const metafieldNamespace = "single_page_checkout";
    const metafieldKey = "documentType";
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime5.jsxs)(BlockStack2, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime5.jsx)(Checkbox2, { checked, onChange: handleChange, children: "Provide delivery instructions" }),
